/**
 * @fileoverview stats/view.js - Stats View Layer
 * 
 * Contains all DOM mutations and Chart.js rendering logic for the statistics page.
 * Strictly operates on pre-computed data passed from the controller and never reads state
 * or issues network requests directly.
 */
// ── Chart palette ──────────────────────────────────────────────────────────
export const C = {
